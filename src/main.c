...
void init_stuff (command_line_options *clOptions)
{
  ...
  // JR: gtk_scrolled_window_set_policy(GTK_SCROLLED_WINDOW (w), GTK_POLICY_NEVER, GTK_POLICY_NEVER); // JR: 2019/02/23: disable both scrollbars
  //     - now this is done via a UI option in xo-callbacks.{c,h} and in ../xournal.ui
